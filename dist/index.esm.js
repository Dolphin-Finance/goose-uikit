...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/BottlenoseFinance",
      },
      {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/DolphinFinance3",
      },
    {
        label: "Reddit",
        icon: "RedditIcon",
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#26c7c9", background: "#F3E5AC", backgroundDisabled: "#979797", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#4c84c4", primaryDark: "#F11CB0", tertiary: "#f0f8ff", text: "#178CA4", textDisabled: "#696969", textSubtle: "#41BEFC", borderColor: "#FF0000", card: "#ffffff", gradients: {
